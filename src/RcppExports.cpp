...
RcppExport SEXP _oglm_dmvnrm_arma_mc(SEXP xSEXP, SEXP meanSEXP, SEXP sigmaSEXP, SEXP logdSEXP, SEXP coresSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_oglm_dmvnrm_arma_mc", (DL_FUNC) &_oglm_dmvnrm_arma_mc, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_oglm(DllInfo *dll) {
